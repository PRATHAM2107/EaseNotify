...
def notification_email(request):
    email = request.GET.get('email')
    send_email("EaseNotify recommends following productt!!!", "<h4>Check out your intentful products.</h4><img src='https://static.pexels.com/photos/133919/pexels-photo-133919-medium.jpeg' width='100px' height='150px'/>", email)
    return HttpResponse("done")
