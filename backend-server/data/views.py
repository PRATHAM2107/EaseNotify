...
def send_note_all(request):
    try:
        ...
        message_body = "EaseNotify has been promoted all over the world"
...
def send_note(request):
    try:
        ...
        message_title = "New service launch"
        message_body = "EaseNotify has launched new merchandise store in town"
...
def export_to_csv(request):
    ...
    #         pg_dump('-h', 'localhost', '-U', 'robomx', 'EaseNotify', _out=f)
